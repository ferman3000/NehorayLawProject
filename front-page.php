...
<div class="cta-action-group">
                <div class="cta-number-display">
                    <svg class="material-icon" fill="currentColor" width="28" height="28" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="offices-section">
            ...
            <article class="office-card office-hemet">
                <div class="office-content">
                    ...
                    <div class="office-details">
                        <p>1600 E Florida Ave. Ste 304.<br>Hemet, CA 92544</p>
                        <p><strong>Phone:</strong> (888) 595-4LAW</p>
                    </div>
                </div>
            </article>
            ...
            <article class="office-card office-riv">
                <div class="office-content">
                    ...
                    <div class="office-details">
                        <p>2100 Embarcadero Suite 201.<br>Oakland, CA 94606</p>
                        <p><strong>Phone:</strong> (888) 595-4LAW</p>
                    </div>
                </div>
            </article>
